...
public class UploadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/pages/upload.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        filePart.write(uploadPath + File.separator + saveFileName + "." + fileExtension);
        ...
        String downloadUrl = req.getContextPath() + "/images/download/"
