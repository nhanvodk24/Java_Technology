...
<form method="post" action="register">
  <table>
    <tr>
      <td>Your Name</td>
      <td>
        <input name="name" type="text" style="width: 200px" placeholder="Full Name" required>
      </td>
    </tr>
    <tr>
      <td>Email Address</td>
      <td><input name="email" type="text" style="width: 200px" placeholder="Email" required></td>
    </tr>
    <tr>
      <td>Birthday</td>
      <td><input name="birthday" type="date" style="width: 200px" required></td>
    </tr>
    <tr>
      <td>Birthtime</td>
      <td><input name="birthtime" type="time" style="width: 200px" required></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td>
    ...
    <tr>
      ...
      <td>
        <textarea name="message" rows="5" style="width: 200px" required></textarea>
      </td>
    </tr>
    <tr>
      <td></td>
